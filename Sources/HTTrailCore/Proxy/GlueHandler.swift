...
/// Relays raw bytes between two channels (client ⇄ origin) for blind CONNECT
/// tunnels — used when a host is excluded from SSL proxying. Standard SwiftNIO
/// "glue" pattern with backpressure propagation.
