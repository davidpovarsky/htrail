...
public struct ProfileGenerator: Sendable {
    ...
    public func makeProfile(caCertificateDER: Data, proxyHost: String, proxyPort: Int,
        ...
        let certPayload: [String: Any] = [
            ...
            "PayloadVersion": 1,
            "PayloadIdentifier": "com.davidpovarsky.pureline.ca.\(stableUUID("ca"))",
        ...
        if includeProxyPayload {
            let proxyPayload: [String: Any] = [
                ...
                "PayloadVersion": 1,
                "PayloadIdentifier": "com.davidpovarsky.pureline.proxy.\(stableUUID("proxy"))",
        ...
        let profile: [String: Any] = [
            ...
            "PayloadVersion": 1,
            "PayloadIdentifier": "com.davidpovarsky.pureline.profile",
    ...
    public func makeCaptureProfile(caCertificateDER: Data, appBundleID: String,
        ...
        let vpnPayload: [String: Any] = [
            ...
            "PayloadVersion": 1,
            "PayloadIdentifier": "com.davidpovarsky.pureline.vpn.\(stableUUID("vpn"))",
        ...
        let profile: [String: Any] = [
            "PayloadType": "Configuration",
            "PayloadVersion": 1,
            "PayloadIdentifier": "com.davidpovarsky.pureline.capture.profile",
